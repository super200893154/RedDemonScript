...
description: '将需求分解为Epic和用户故事。当用户说"创建Epic和故事列表"时使用'
---

请务必执行此命令：加载完整的 @{project-root}/_bmad/bmm/workflows/3-solutioning/create-epics-and-stories/workflow.md，阅读其全部内容并严格按照其指示执行！
