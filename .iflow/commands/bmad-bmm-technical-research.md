...
description: '开展技术和架构的技术研究。当用户说"创建关于[主题]的技术研究报告"时使用。'
---

请务必执行此命令：加载完整的 @{project-root}/_bmad/bmm/workflows/1-analysis/research/workflow-technical-research.md，阅读其全部内容并严格按照其指示执行！
