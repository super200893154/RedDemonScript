...
description: '为AI上下文记录既有项目文档。当用户说"记录此项目"或"生成项目文档"时使用'
---
...
2. 阅读其全部内容 - 这是执行特定工作流配置 @{project-root}/_bmad/bmm/workflows/document-project/workflow.yaml 的核心操作系统
3. 将 yaml 路径 @{project-root}/_bmad/bmm/workflows/document-project/workflow.yaml 作为 'workflow-config' 参数传递给 workflow.xml 指令
