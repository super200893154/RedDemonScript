---
name: 'create-prd'
description: '从零开始创建PRD。当用户说"让我们创建产品需求文档"或"我想创建新的PRD"时使用'
---

请务必执行此命令：加载完整的 @{project-root}/_bmad/bmm/workflows/2-plan-workflows/create-prd/workflow-create-prd.md，阅读其全部内容并严格按照其指示执行！
