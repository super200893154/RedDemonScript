...
description: '为现有功能生成端到端自动化测试。当用户说"为[功能]创建QA自动化测试"时使用'
---
...
2. 阅读其全部内容 - 这是执行特定工作流配置 @{project-root}/_bmad/bmm/workflows/qa-generate-e2e-tests/workflow.yaml 的核心操作系统
3. 将 yaml 路径 @{project-root}/_bmad/bmm/workflows/qa-generate-e2e-tests/workflow.yaml 作为 'workflow-config' 参数传递给 workflow.xml 指令
