---
name: 'brainstorming'
description: '使用多种创意技巧和构思方法促进互动式头脑风暴会议。当用户说"帮我头脑风暴"或"帮我构思"时使用。'
---

请务必执行此命令：加载完整的 @{project-root}/_bmad/core/workflows/brainstorming/workflow.md，阅读其全部内容并严格按照其指示执行！
