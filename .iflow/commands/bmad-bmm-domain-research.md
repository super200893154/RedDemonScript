...
description: '开展领域和行业研究。当用户说"让我们创建关于[领域或行业]的研究报告"时使用'
---

请务必执行此命令：加载完整的 @{project-root}/_bmad/bmm/workflows/1-analysis/research/workflow-domain-research.md，阅读其全部内容并严格按照其指示执行！
