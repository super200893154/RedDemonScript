---
name: 'create-story'
description: '创建包含智能体后续实现所需全部上下文的专属故事文件。当用户说"创建下一个故事"或"创建故事 [故事标识符]"时使用'
---
...
2. 阅读其全部内容 - 这是执行特定工作流配置 @{project-root}/_bmad/bmm/workflows/4-implementation/create-story/workflow.yaml 的核心操作系统
3. 将 yaml 路径 @{project-root}/_bmad/bmm/workflows/4-implementation/create-story/workflow.yaml 作为 'workflow-config' 参数传递给 workflow.xml 指令
