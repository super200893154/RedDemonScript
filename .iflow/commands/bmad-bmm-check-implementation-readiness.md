...
description: '验证PRD、UX、架构和Epic规范是否完整。当用户说"检查实现准备度"时使用。'
---

请务必执行此命令：加载完整的 @{project-root}/_bmad/bmm/workflows/3-solutioning/check-implementation-readiness/workflow.md，阅读其全部内容并严格按照其指示执行！
