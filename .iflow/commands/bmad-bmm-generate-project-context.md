...
description: '创建包含AI规则的project-context.md。当用户说"生成项目上下文"或"创建项目上下文"时使用'
---

请务必执行此命令：加载完整的 @{project-root}/_bmad/bmm/workflows/generate-project-context/workflow.md，阅读其全部内容并严格按照其指示执行！
