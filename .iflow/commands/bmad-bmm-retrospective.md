---
name: 'retrospective'
description: 'Epic完成后评审以提取经验教训并评估成功。当用户说"运行回顾"或"让我们对Epic [epic]进行回顾"时使用'
---
...
2. 阅读其全部内容 - 这是执行特定工作流配置 @{project-root}/_bmad/bmm/workflows/4-implementation/retrospective/workflow.yaml 的核心操作系统
3. 将 yaml 路径 @{project-root}/_bmad/bmm/workflows/4-implementation/retrospective/workflow.yaml 作为 'workflow-config' 参数传递给 workflow.xml 指令
