---
name: 'correct-course'
description: '在迭代执行期间管理重大变更。当用户说"纠正航向"或"提出迭代变更"时使用'
---
...
2. 阅读其全部内容 - 这是执行特定工作流配置 @{project-root}/_bmad/bmm/workflows/4-implementation/correct-course/workflow.yaml 的核心操作系统
3. 将 yaml 路径 @{project-root}/_bmad/bmm/workflows/4-implementation/correct-course/workflow.yaml 作为 'workflow-config' 参数传递给 workflow.xml 指令
