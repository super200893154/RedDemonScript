...
description: '通过协作发现创建产品简介。当用户说"让我们创建产品简介"或"帮我创建项目简介"时使用'
---

请务必执行此命令：加载完整的 @{project-root}/_bmad/bmm/workflows/1-analysis/create-product-brief/workflow.md，阅读其全部内容并严格按照其指示执行！
