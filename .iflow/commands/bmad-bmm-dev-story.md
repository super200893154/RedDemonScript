---
name: 'dev-story'
description: '按照包含上下文的故事规范文件执行故事实现。当用户说"开发此故事 [故事文件]"或"实现迭代计划中的下一个故事"时使用'
---
...
2. 阅读其全部内容 - 这是执行特定工作流配置 @{project-root}/_bmad/bmm/workflows/4-implementation/dev-story/workflow.yaml 的核心操作系统
3. 将 yaml 路径 @{project-root}/_bmad/bmm/workflows/4-implementation/dev-story/workflow.yaml 作为 'workflow-config' 参数传递给 workflow.xml 指令
