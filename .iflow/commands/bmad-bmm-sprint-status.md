---
name: 'sprint-status'
description: '汇总迭代状态并提示风险。当用户说"检查迭代状态"或"显示迭代状态"时使用'
---
...
2. 阅读其全部内容 - 这是执行特定工作流配置 @{project-root}/_bmad/bmm/workflows/4-implementation/sprint-status/workflow.yaml 的核心操作系统
3. 将 yaml 路径 @{project-root}/_bmad/bmm/workflows/4-implementation/sprint-status/workflow.yaml 作为 'workflow-config' 参数传递给 workflow.xml 指令
