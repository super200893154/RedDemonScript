---
name: 'quick-dev'
description: '针对小型变更或功能实现快速技术规范。当用户提供快速技术规范并说"实现此快速规范"或"开始实现[快速技术规范]"时使用'
---

请务必执行此命令：加载完整的 @{project-root}/_bmad/bmm/workflows/bmad-quick-flow/quick-dev/workflow.md，阅读其全部内容并严格按照其指示执行！
