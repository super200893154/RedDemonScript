---
name: validate-prd
description: '根据标准验证 PRD。当用户说"验证这个 PRD"或"运行 PRD 验证"时使用'
...
"**验证模式：根据 BMAD 标准验证现有 PRD。**"

然后完整阅读并遵循：`{validateWorkflow}`（steps-v/step-v-01-discovery.md）